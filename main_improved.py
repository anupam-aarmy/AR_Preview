...
def run_improved_task1():
    ...
    try:
        ...
        print("   Please ensure task1_fixed_placement.py exists in scripts/")
        print("   Falling back to improved task1_improved_placement.py...")
        try:
            from task1_improved_placement import main as task1_fallback
            task1_fallback()
            print("\n✅ Task 1 (fallback) completed!")
        except Exception as e2:
            print(f"❌ Task 1 fallback also failed: {e2}")
...
def run_improved_task2():
    ...
    try:
        from task2_improved_placement import main as task2_main
        task2_main()
